...
## 🔧 Technical Skills
- **Languages:** R, SQL  
- **Analytics:** Data Cleaning, EDA, KPI Tracking, Predictive Analysis  
- **Visualization:** Tableau, Power BI, ggplot2  
- **Tools:** Excel (Pivot Tables, Forecasting), MySQL, RStudio, RapidMiner  
- **Strengths:** Technical communication, public speaking, stakeholder insight, continuous improvement  
...
### **Online Analyst — Intellectual Property Investigations**  
Analyzed 500+ domain URLs to evaluate eCommerce activity, brand presence, and potential infringement. Maintained structured datasets, applied classification techniques, and delivered insights that supported client decision-making.

### **Customer Experience Evaluator — Mystery Shopper**  
Conducted 50+ structured evaluations across retail and hospitality, collecting quantitative and qualitative data to assess compliance, service quality, and brand standards.

### **Fitness & Rowing Coach**  
Used performance metrics (split times, stroke rates, heart rate data) to customize training plans, track progress, and improve client outcomes. Trained 100+ clients while maintaining data accuracy, privacy, and clear communication.
